...
interface SeoPanelProps {
  courseId: string
  initialData: Pick<CourseData, 'metaTitle' | 'metaDescription'> & {
    ogImage?: {
      id: string
      title: string | null
...
export function SeoPanel({ courseId, initialData }: SeoPanelProps) {
    ...
    <form onSubmit={handleSave} className="space-y-5">
      <div className="flex flex-col gap-1.5">
        ...
        <Input
          ...
          placeholder="Overrides the course title in search results"
          maxLength={120}
        />
